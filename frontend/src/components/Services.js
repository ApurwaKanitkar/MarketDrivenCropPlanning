  ...
  return (
    <div>
      ...
      <div className="text-center">
        ...
        <button
          onClick={handleAsk}
          class="w-20 h-10 m-10 rounded-md transition delay-150 bg-black text-white hover:-translate-y-0.2 hover:scale-110 hover:bg-black hover:text-white duration-300"
        >
          Ask
        </button>
      </div>
      <div className="response-container">
        {show && (
          <p className="border shadow-2xl p-5 rounded-lg border-gray-300 ml-20 mr-20 mb-10 text-justify">
            {response}
          </p>
        )}
      </div>
